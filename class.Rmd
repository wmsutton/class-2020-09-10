...
ggplot(data = x, aes(x = mean_age)) + 
  geom_histogram(bins = 20, color = "#d1fff4", fill = "#ffd1dc") + 
  xlim(25, 55) +
  labs(title = "Mean Age of Kenyan Voters", x = "Mean Age (Years)", y = "Number of Voters") +
  theme_bw()
```
...
ggplot(data = x, aes(x = reg_inc)) + 
  geom_histogram(bins = 20, fill = "#BAF2E9", color = "#F95738")+ scale_x_log10()
```
